...
function detectFruit(
    ...
    for(
        const fruit of Object.keys(scores)
    ){

        if(
            scores[fruit] > bestScore
        ){
...
app.listen(
    ...
    () => {
        ...
        console.log(
            "🧠 MobileNet + Pixel Analysis"
        );

        console.log(
            "🍳 Fruit-specific Recipe Engine"
        );
